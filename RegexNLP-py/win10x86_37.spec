...
a = Analysis(['__main_simple__.py'],
             pathex=['build_requirements\\ucrt\\DLLs\\x86', os.path.join(os.path.dirname(scipy.__file__), 'extra-dll'),
                os.getcwd()],
             binaries=[],
             datas=[(os.path.join(os.path.dirname(scipy.__file__), 'special', '_ufuncs_cxx.cp37-win32.pyd'),'.'),],
